...
*Update, March 2026:* There have been further changes to the API since I wrote these pages in 2025. Most noticeably, the original API URLs will no longer work in these R scripts (you'll get a 403 Forbidden error). So far I've also spotted at least one small (but breaking) change to the JSON; there may be more. There should not be any substantive changes to categories and so on, but I haven't checked in detail.

I cover two of the available API endpoints here:

-  https://www.dhi.ac.uk/api-proto/view/oldbailey_record - for searching trials and other sections in the Old Bailey Proceedings
-  https://www.dhi.ac.uk/api-proto/view/oldbailey_record_single - for full data about individual trials and other sections in the Proceedings
...
- https://www.dhi.ac.uk/api-proto/view/oldbailey_record**?offence=kill** 
...
So, the second page for the example above: https://www.dhi.ac.uk/api-proto/view/oldbailey_record?offence=kill&from=10
...
The number of results (hits > total > value)

```{r}
sample_search_json$hits$total$value
```
